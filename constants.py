...
NUM_MINES =   10, 12, 14, 16, 18, 20, 22, 24, 26 # number of mines per map
NUM_BEACONS = 14, 14, 15, 19, 20, 21, 24, 25, 26 # number of flags/beacons per map
# player
...
CREDITS += '"Victory" by cynicmusic     "Thunderchild" by Otto Halmen     "RPG title" by HitCtrl     '
CREDITS += '"Ashen" by TheMightyRager     "Battle" by Beau Buckley     '
