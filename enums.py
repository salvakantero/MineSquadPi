...
# map data [mines info]
MI_MINE, MI_FREE, MI_BEACON, MI_BEACON2 = -1, 0, 9, 10 # proximity: 1,2,3,4,5,6,7,8  BEACON=green flag, BEACON2=red flag

# enemy types
EN_SCORPION, EN_SNAKE, EN_SOLDIER0, EN_PROJECTILE, EN_CRAB, EN_SOLDIER1, EN_SKIER, \
EN_BOAR, EN_SOLDIER2 = 0, 1, 2, 3, 4, 5, 6, 7, 8

# enemy movement
EM_HORIZONTAL, EM_VERTICAL, EM_RANDOM, EM_CHASER, EM_HORIZONTAL_LOOP, EM_VERTICAL_LOOP = 0, 1, 2, 3, 4, 5

# hotspots
HS_LIFE, HS_SHIELD, HS_AMMO, HS_BEACON, HS_CANDY, HS_APPLE, HS_CHOCO, HS_COIN = 0, 1, 2, 3, 4, 5, 6, 7
