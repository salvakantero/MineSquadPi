...
# map data [mines info]
MI_MINE, MI_FREE, MI_BEACON, MI_BEACON2 = -1, 0, 9, 10 # proximity: 1,2,3,4,5,6,7,8

# enemy types
EN_SCORPION, EN_SNAKE, EN_SOLDIER0, EN_CRAB, EN_PROJECTILE, EN_SOLDIER1, EN_SKIER, \
...
# hotspots
HS_LIFE, HS_SHIELD, HS_AMMO, HS_BEACONS, HS_CANDY, HS_APPLE, HS_CHOCO, HS_COIN = 0, 1, 2, 3, 4, 5, 6, 7
